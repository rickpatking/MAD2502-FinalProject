...
def build_weighted_graph(vor: Voronoi, sites: np.ndarray, rescue_time: bool=True) -> dict:
    ...
    :param rescue_time: A bool representing urgency of the rescue. If it isn't urgent (True), the algorithm
    will take a safer, but longer route. Otherwise (False), the algorithm will take a shorter, but riskier route.
